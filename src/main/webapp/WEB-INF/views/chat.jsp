...
<body> 
	                            	...
	                            	<c:forEach items="${list }" var="list" varStatus="status">
		                                    ...
		                                    <div class="d-flex bd-highlight">
		                                        ...
		                                        <div class="chat_product_info">
		                                            ...
		                                            <span class="status"><c:out value="${list.email }"/></span>
					                                 			<p>TEST TEXT FIELD</p>
		                                        </div>
		                                    </div>
		                                </li>
	                ...
	                <div class="col-md-8 col-xl-6 chat">
	                    <div class="card">	                       
	                        ...
	                        <div class="card-footer">
	                            <div class="input-group">
	                                <span class="input-group-text attach_btn"><i class="fas fa-paperclip"></i><input type="file"></span>
  ...
  //Firebase 프로젝트에서 추출한 정보 입력
    ...
    apiKey: "AIzaSyDoSfivcMB3xFX0tAaHWi42hRttRCziKIc",
    authDomain: "hamchat-5f5d6.firebaseapp.com",
    databaseURL: "https://hamchat-5f5d6-default-rtdb.firebaseio.com",
    projectId: "hamchat-5f5d6",
    storageBucket: "hamchat-5f5d6.appspot.com",
    messagingSenderId: "541249120137",
    appId: "1:541249120137:web:28d098b10dc14e071fe358",
    measurementId: "G-PGBHFL2CFJ"
  };	
	// Initialize Firebase
...
// 221105000000 -> 22-11-05 00:00:00
