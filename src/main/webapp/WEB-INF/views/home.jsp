...
<!---------------------------------------------------------------------- body(keyboard) ----------------------------------------------------------->
<div id="back" style="height: 750px; width: 100%; background: url(./image/green4.png); background-size: cover; background-attachment: scroll;">
</div>
<br><br>
<!-- body -->
<div class="container">
...
<div style="width: 100%; height: 500px; background: url(./image/desk.jpg); background-size: cover; background-attachment: fixed; "></div>
