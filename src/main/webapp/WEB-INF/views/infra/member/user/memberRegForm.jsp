			...
			<div class="container">
				...
				<div class="row mb-0">
					<div class="col">
						...
						<div class="form-floating d-flex justify-content-center">
							<input type="text" class="form-control pt-1" id="user_email" style="width: 140px; height: 50px; margin-left: 120px; margin-right: 20px;">@ <input type="text" class="form-control pt-1" id="email_address" style="width: 140px; height: 50px; margin-left: 20px; margin-right: 20px;"> <select class="form-select pt-1" id="domain-list" style="width: 140px; height: 50px; margin-right: 20px;">
								<option value="type">직접 입력</option>
								<option value="naver.com">naver.com</option>
								<option value="gmail.com">gmail.com</option>
								<option value="daum.net">daum.net</option>
							</select> <input type="text" class="form-control pt-1" id="email" name="email" style="width: 140px; height: 50px; margin-left: 20px; margin-right: 20px;">
