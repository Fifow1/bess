			...
			<div class="row loginbtn d-flex justify-content-center">
				<div class="col mb-5">
					<div class="d-flex justify-content-center" style="padding-right: 30px;">
						<a href="#" class="link-dark" style="text-decoration: none; padding:0;" onclick="location.href='./memberFindid_phone.html'">휴대폰인증</a>
						<div class="linesm"></div>
						<a href="#" class="link-dark ps-5" style="text-decoration: none; padding:0;" onclick="location.href='./memberFindid_phone.html'">이메일인증</a>
					</div>
				</div>
			</div>
			<div class="row loginbtn d-flex justify-content-center">
