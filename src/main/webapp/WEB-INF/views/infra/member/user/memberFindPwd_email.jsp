	...
	<div style="width: 40%; height:1000px; float:left; margin-top: 250px;">
		<div class="row">
			<div class="col d-flex justify-content-center">
				<p style="font-family: 'Source Sans Pro', sans-serif; font-size: 80px; ">Find pwd<br>email</p>
			</div>
		</div>
		<div class="row">
			<div class="col d-flex justify-content-center">
				<hr style="border: solid 4px #2E2E2E; width: 340px; opacity: .9;">
			</div>
		</div>
	</div>
	...
	<div style="width: 60%; height:1000px; float:right; padding-top: 200px;">
		<div class="container">
			<div class="row loginbtn d-flex justify-content-center">
				<div class="col mb-5">
					<div class="d-flex justify-content-center" style="padding-right: 30px;">
						<a href="#" class="link-dark" style="text-decoration: none; padding:0;" onclick="location.href='./memberFindpwd_phone.html'">휴대폰인증</a>
						<div class="linesm"></div>
						<a href="#" class="link-dark ps-5" style="text-decoration: none; padding:0;" onclick="location.href='./memberFindpwd_email.html'">이메일인증</a>
					</div>
				</div>
			</div>
			<div class="row loginbtn d-flex justify-content-center">
				<div class="col mb-3">
					<div class="form-floating d-flex justify-content-center">
					 	...
					 	<label for="floatingInput" style="margin-left: 250px;">아이디<label>
					</div>
				</div>
			</div>
			<div class="row loginbtn d-flex justify-content-center">
			...
			<div class="row">
				<div class="col mb-4 d-flex justify-content-center">
					<button type="button" class="btn btn-dark" style="width: 620px;">비밀번호 확인</button>		
				</div>
			</div>
			<div class="row">
				<div class="col mb-3 d-flex justify-content-center" style="padding-right: 490px;">
					<a href="#" class="link-dark ps-5">인증번호를 받지 못하셨나요?</a>		
				</div>
			</div>
		</div>
	</div>
